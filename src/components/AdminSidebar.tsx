  ...
  return (
    <>
      ...
      <div className="relative z-40 lg:hidden">
        ...
        <div className={`fixed inset-y-0 left-0 z-50 w-72 bg-surface-container border-r border-outline-variant transform transition-transform duration-300 ease-in-out ${isMobileOpen ? 'translate-x-0' : '-translate-x-full'
          }`}>
                ...
                {navigation.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      className={`flex items-center justify-between px-4 py-3.5 transition-all group ${isActive
              ...
              {navigation.map((item) => {
                ...
                return (
                  <Link
                    key={item.name}
                    href={item.href}
                    className={`flex items-center justify-between px-5 py-4 transition-all group border-l-2 ${isActive
